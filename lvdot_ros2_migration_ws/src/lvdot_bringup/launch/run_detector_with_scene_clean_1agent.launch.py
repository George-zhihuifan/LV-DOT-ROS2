...
def generate_launch_description() -> LaunchDescription:
    ...
    scene_launch = depth_eval_share / "launch" / "uav_pedestrian_clean_single.launch.py"
    ...
    default_scenario_config = str(
        Path(get_package_share_directory("lvdot_bringup")) / "config" / "clean_scenarios" / "pedestrian_clean_01agent.yaml")
