"""Full pipeline launch for the clean 1-agent QC-GAF inspection scene."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    scene_launch = bringup_share / "launch" / "run_detector_with_scene_clean_1agent.launch.py"
    ...
    default_scenario_config = str(bringup_share / "config" / "clean_scenarios" / "pedestrian_clean_01agent.yaml")
