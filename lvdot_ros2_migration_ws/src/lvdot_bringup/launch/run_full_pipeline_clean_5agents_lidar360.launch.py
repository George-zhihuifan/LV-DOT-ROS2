"""Full pipeline launch — clean 5-agent, NEW LiDAR-360 path (per-object LiDAR promotion ON). Existing pipeline unchanged; this just flips qcgaf_enable_lidar_only_promotion on."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    scene_launch = bringup_share / "launch" / "run_detector_with_scene_clean_5agents.launch.py"
    ...
    default_scenario_config = str(bringup_share / "config" / "clean_scenarios" / "pedestrian_clean_05agents.yaml")
