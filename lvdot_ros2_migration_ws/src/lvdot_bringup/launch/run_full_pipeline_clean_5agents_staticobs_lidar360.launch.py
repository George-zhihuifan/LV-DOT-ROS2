"""Full pipeline launch — clean 5-agent + static obstacles, NEW LiDAR-360 path (per-object LiDAR promotion ON). Existing pipeline unchanged; this just flips qcgaf_enable_lidar_only_promotion on."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    scene_launch = bringup_share / "launch" / "run_detector_with_scene_clean_5agents_staticobs.launch.py"
