"""Full pipeline launch — clean 6-agent, NEW LiDAR-360 path (per-object LiDAR promotion ON). Existing pipeline unchanged; this just flips qcgaf_enable_lidar_only_promotion on."""
