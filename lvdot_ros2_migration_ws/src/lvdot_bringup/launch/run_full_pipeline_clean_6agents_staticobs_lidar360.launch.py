"""Full pipeline launch — clean 6-agent + static obstacles, NEW LiDAR-360 path (per-object LiDAR promotion ON). Existing pipeline unchanged; this just flips qcgaf_enable_lidar_only_promotion on."""
...
def generate_launch_description() -> LaunchDescription:
    ...
    scene_launch = bringup_share / "launch" / "run_detector_with_scene_clean_6agents_staticobs.launch.py"
    ...
    default_scenario_config = str(bringup_share / "config" / "clean_scenarios" / "pedestrian_clean_06agents_staticobs.yaml")
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("qcgaf_enable_lidar_only_promotion", default_value="true"),
        DeclareLaunchArgument("qcgaf_lidar_only_match_distance", default_value="0.9"),
        ...
        Node(
            ...
            parameters=[{
                ...
                "enable_lidar_only_promotion": LaunchConfiguration("qcgaf_enable_lidar_only_promotion"),
                "lidar_only_match_distance": LaunchConfiguration("qcgaf_lidar_only_match_distance"),
