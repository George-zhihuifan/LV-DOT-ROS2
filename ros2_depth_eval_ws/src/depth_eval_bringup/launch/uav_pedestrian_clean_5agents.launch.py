...
def generate_launch_description() -> LaunchDescription:
    ...
    world_path = os.path.join(pkg_bringup, 'worlds', 'pedestrian_clean_5agents.sdf')
    model_path = os.path.join(pkg_bringup, 'models')
    default_config_path = os.path.join(pkg_bringup, 'config', 'pedestrian_clean_05agents.yaml')
    config_path = LaunchConfiguration('scenario_config')
    rviz_config = os.path.join(pkg_bringup, 'rviz', 'uav_pedestrian_scene.rviz')
    world_name = 'pedestrian_clean_5agents'
